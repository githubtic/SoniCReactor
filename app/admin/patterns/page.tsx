...
async function PatternsContent() {
  try {
    ...
    // Fetch sound patterns with error handling
    let patterns = []
    try {
    ...
    console.error("Error in PatternsContent:", error)
    return (
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
        ...
        <div className="p-4 text-center text-destructive">An error occurred while loading sound patterns.</div>
      </div>
    )
  }
}
